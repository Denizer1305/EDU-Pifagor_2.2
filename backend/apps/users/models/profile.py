...
class Profile(models.Model):
    ...
    Здесь лежат базовые данные, не привязанные к роли пользователя.
    """
    ...
    about = models.TextField(_("О себе"), blank=True)
    city = models.CharField(_("Город"), max_length=150, blank=True)
    ...
    def short_name(self) -> str:
        """Возвращает краткое имя профиля."""
        initials = []
        if self.first_name:
